...
static constexpr auto qt_meta_stringdata_CLASSchildDialogENDCLASS = QtMocHelpers::stringData(
    "childDialog",
    "displayMain",
    "",
    "doSomething"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSchildDialogENDCLASS_t qt_meta_stringdata_CLASSchildDialogENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(12, 11),  // "displayMain"
        QT_MOC_LITERAL(24, 0),  // ""
        QT_MOC_LITERAL(25, 11)   // "doSomething"
    },
    "childDialog",
    "displayMain",
    "",
...
void childDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &childDialog::displayMain; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
